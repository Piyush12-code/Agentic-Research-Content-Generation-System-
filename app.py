...
topic = "Industries using Generative AI"
...
research_analyst = Agent(
    ...
    backstory = "You're an expert research analyst with advanced web research skills."
                ...
                "You provide well-organized research briofs with proper citations and source verification"
...
content_writer = Agent(
    ...
    backstory = "You're a skilled content writer specialized in creating engaging, accessible content from technical research."
                "You work closely with the Research Analyst and excel at maintaining the perfect balance between informative and entertaining writing, while ensuring all facts and citations from the research are properly incorporated."
...
research_tasks = Task(
    description = ("""
        ...
        """),
    expected_output = """A detalled research report containing:
            - Executive summary of key findings
            - Comprehensive analysis of current trends and developments
            - List of verified facts and statistics
            - All citations and links to original sources
            - Clear categorization of main themes and patterns Please format with clear sections and bullet points for easy reference.""",
...
writing_task = Task(
    description = ("""
        ...
        2. Maintains all factual accuragy and citations from the research
        3. Includes:
